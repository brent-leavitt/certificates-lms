...
/* 		curl_setopt($ch, CURLOPT_CAINFO, 
    ...
    protected function fsockPost($encoded_data) {
        ...
        $header .= "User-Agent: new-beginnings-doula-training\r\n\r\n";
     ...
     *  Get Post Data
     *
     *  Returns the Post Data for further processing.
     *
     *  @return array
     */
    public function getPostData() {
		$post_data_array = $this->post_data;
		foreach( $post_data_array as $key => $value ) {
            $post_data_array[ $key ] = urldecode( $value );
        }	
